...
export const SalesAgentsCreateTableCoulumns =
  `UserCode INTEGER  PRIMARY KEY NOT NULL, AllowCreditSale  BOOLEAN, IsAdminUser  BOOLEAN, ` +
  `SalesAgentCode TEXT, SalesAgentName TEXT, Email TEXT, Phone TEXT, Mobile TEXT, DiscountLimit FLOAT`;
