  ...
  return (
    <Modal visible={displayAlert} transparent={true} animationType={'fade'}>
      <View
        ...
        <View style={{width:'90%',backgroundColor:'#3a74bf',borderTopLeftRadius:sizeHelper.calHp(20),borderTopRightRadius:sizeHelper.calHp(20)}}>
            <Text style={{color:'white',padding:sizeHelper.calHp(20),fontSize:sizeHelper.calHp(28)}}>Allow Notifications</Text>
          </View>
        <View
          style={{
            width: '90%',
            ...
            // justifyContent: 'center',
            // alignItems: 'center',
            borderBottomLeftRadius: sizeHelper.calHp(20),
            borderBottomRightRadius: sizeHelper.calHp(20),
          ...
          <ScrollView
            ...
            <Text
                ...
                Welcome to the FXC POS Restaurant Terms application.{'\n'}
                Application of the Terms of Use (hereinafter referred to as the
                "Service")
                {'\n'}• Our Privacy Policy governs your visit to FXC.com, and
                ...
                {'\n'}
                2. Definitions{'\n'}• Services means FXC.com operated by FXC
                ...
                transfer.
                {'\n'}FXC POS Restaurant App will take all steps reasonably
                ...
                systems,{'\n'}please email us at info@FXC.com.
                ...
                contact us by Email: info@FXC.com
              </Text>
            {/* <Text
              style={{
              ...
              {'\n'}تحكم سياسة الخصوصية الخاصة بنا زيارتك لموقع FXC.com ،
              ...
              يتم تحديد خلاف ذلك في سياسة الخصوصية هذه ، فإن المصطلحات المستخدمة
              في سياسة الخصوصية هذه لها نفس المعاني كما في الشروط والأحكام
              الخاصة بنا.
              {'\n'} تحكم شروطها وأحكامها ("الشروط") جميع استخدامات خدمتنا وتشكل
              جنبًا إلى جنب مع سياسة الخصوصية اتفاقك معنا ("الاتفاقية").
              {'\n'} 2. التعاريف
              {'\n'}الخدماتيقصد به موقع FXC.com الذي يديره تطبيق FXC POS.
              ...
              طريق استخدام الخدمة أو من البنية التحتية للخدمة نفسها (على سبيل
              المثال ، مدة زيارة الصفحة).
              {'\n'} الكوكيز هي ملفات صغيرة مخزنة على جهازك (الكمبيوتر أو الجهاز
              المحمول).
              {'\n'}متحكم بيانات تعني شخصًا طبيعيًا أو اعتباريًا (إما بمفرده أو
              بشكل مشترك أو بالاشتراك مع أشخاص آخرين) يحدد الأغراض التي من أجلها
              والطريقة التي تتم بها معالجة أي بيانات شخصية أو يتعين معالجتها
              لغرض سياسة الخصوصية هذه ، نحن نراقب البيانات لبياناتك.
              {'\n'}معالجات البيانات (أو مقدمو الخدمة)يُقصد بها أي شخص طبيعي أو
              اعتباري يقوم بمعالجة البيانات نيابة عن وحدة التحكم في البيانات قد
              نستخدم خدمات مختلفة لمقدمي الخدمة من أجل معالجة بياناتك بشكل أكثر
              فعالية.
              ...
              ("البيانات الشخصية"). قد تتضمن معلومات التعريف الشخصية ، على سبيل
              المثال لا الحصر:
              ...
              الإخبارية والمواد التسويقية أو الترويجية وغيرها من المعلومات التي
              قد تهمك. يمكنك إلغاء الاشتراك في تلقي أي من هذه الاتصالات أو
              جميعها منا باتباع رابط إلغاء الاشتراك.
              {'\n'} بيانات الاستخدام
              {'\n'}قد نقوم أيضًا بجمع المعلومات التي يرسلها متصفحك عندما تزور
              خدمتنا أو عندما تصل إلى الخدمة عن طريق أو من خلال أي جهاز ("بيانات
              الاستخدام").
              {'\n'} قد تتضمن بيانات الاستخدام هذه معلومات مثل عنوان بروتوكول
              الإنترنت لجهاز الكمبيوتر الخاص بك (مثل عنوان IP) ، ونوع المتصفح ،
              وإصدار المتصفح ، وصفحات الخدمة التي تزورها ، ووقت وتاريخ زيارتك ،
              والوقت الذي تقضيه على تلك الصفحات ، معرّفات الجهاز الفريدة وبيانات
              التشخيص الأخرى.
              {'\n'}عند الوصول إلى الخدمة باستخدام جهاز ، قد تتضمن بيانات
              الاستخدام هذه معلومات مثل نوع الجهاز الذي تستخدمه ، و المعرف
              الفريد لجهازك ، وعنوان IP الخاص بجهازك ، ونظام تشغيل جهازك ، ونوع
              متصفح الإنترنت الذي تستخدمه ، معرّفات الجهاز الفريدة وبيانات
              التشخيص الأخرى.
              {'\n'} بيانات الموقع
              ...
              {'\n'} يمكنك تمكين أو تعطيل خدمات الموقع عند استخدام خدماتنا في أي
              وقت عن طريق إعدادات جهازك.
              ...
              البيانات التي قد تتضمن معرفًا فريدًا مجهول الهوية. يتم إرسال ملفات
              تعريف الارتباط إلى متصفحك من موقع ويب وتخزينها على جهازك. تُستخدم
              تقنيات التتبع الأخرى أيضًا مثل الإشارات والعلامات والنصوص لجمع
              المعلومات وتتبعها و تحسين خدمتنا وتحليلها.
              ...
              التالية: الجنس ، والعمر ، وتاريخ الميلاد ، ومكان الميلاد ، وتفاصيل
              جواز السفر ، والجنسية ، والتسجيل في مكان الإقامة والعنوان الفعلي ،
              ورقم الهاتف (العمل ، والجوال) ، تفاصيل المستندات في التعليم
              والتأهيل والتدريب المهني واتفاقيات العمل ،اتفاقيات NDA، معلومات عن
              المكافآت والتعويضات ، معلومات عن الحالة الاجتماعية ، أفراد الأسرة
              ، رقم الضمان الاجتماعي (أو رقم تعريف دافع الضرائب الآخر) ، أو موقع
              المكتب وبيانات أخرى.
              {'\n'} 5. استخدام البيانات
              {'\n'} يستخدم تطبيق FXC POS البيانات التي تم جمعها لأغراض
              مختلفة:
              {'\n'} 0.1. لتقديم خدماتنا والحفاظ عليها
              {'\n'} 0.2 لإعلامك عن تغييرات لخدمتنا
              {'\n'} 0.3 السماح لك بالمشاركة في الميزات التفاعلية لخدمتنا عندما
              تختار القيام بذلك
              ...
              {'\n'} 0.9 تنفيذ التزاماتنا وإنفاذ حقوقنا الناشئة عن أي عقود مبرمة
              بينك وبيننا ، بما في ذلك الفواتير والتحصيل
              {'\n'} 0.10. لتزويدك بإشعارات حول حسابك / أو اشتراكك ، بما في ذلك
              إشعارات انتهاء الصلاحية والتجديد وإرشادات البريد الإلكتروني وما
              إلى ذلك
              {'\n'} 0.11. لتزويدك بالاخبار والعروض الخاصة والمعلومات العامة حول
              السلع والخدمات والأحداث الأخرى التي نقدمها والتي تشبه تلك التي
              ...
              بلدك أو الولاية القضائية الحكومية الأخرى التي قد تختلف فيها قوانين
              حماية البيانات عن تلك الموجودة في ولايتك القضائية. إذا كنت
              متواجدًا خارج المملكة العربية السعودية و اخترت تقديم معلومات لنا ،
              يرجى ملاحظة أننا نقوم بنقل البيانات ، بما في ذلك البيانات الشخصية
              ، إلى المملكة العربية السعودية ومعالجتها هناك. موافقتك على سياسة
              الخصوصية هذه متبوعة بتقديمك لهذه المعلومات تمثل موافقتك على هذا
              النقل. سيتخذ تطبيق FXC POS جميع الخطوات اللازمة بشكل معقول لضمان
              معالجة بياناتك بشكل آمن ووفقًا لسياسة الخصوصية هذه ولن يتم نقل
              بياناتك الشخصية إلى منظمة أو دولة ما لم تكن هناك ضوابط كافية مطبقة
              بما في ذلك أمن بياناتك وغيرها من المعلومات الشخصية.
              {'\n'} 8. الإفصاح عن البيانات قد نكشف عن المعلومات الشخصية التي
              نجمعها ، أو تقدم:
              {'\n'} 0.1. الإفصاح عن جهات إنفاذ القانون. في ظل ظروف معينة ، قد
              يُطلب منا الكشف عن بياناتك الشخصية إذا طُلب منا ذلك بموجب القانون
              أو استجابة لطلبات صحيحة من السلطات العامة.
              ...
              {'\n'} 0.3.7. إذا كنا نعتقد أن الإفصاح ضروري أو مناسب لحماية حقوق
              أو ممتلكات أو سلامة الشركة أو عملائنا أو غيرهم.
              {'\n'} 9. أمن البيانات أمان بياناتك مهم بالنسبة لنا ولكن تذكر أنه
              لا توجد وسيلة نقل عبر الإنترنت أو طريقة تخزين إلكتروني آمنة بنسبة
              100٪. بينما نسعى جاهدين لاستخدام وسائل مقبولة تجاريًا لحماية
              ...
              استخدام بياناتك الشخصية. إذا كنت ترغب في إبلاغك بالبيانات الشخصية
              التي نحتفظ بها عنك وإذا كنت تريد إزالتها من أنظمتنا ، فيرجى
              مراسلتنا عبر البريد الإلكتروني على info@FXC.com. في ظروف معينة ،
              تتمتع بحقوق حماية البيانات التالية:
              {'\n'} 0.1. الحق في الوصول إلى المعلومات التي لدينا عنك أو تحديثها
              أو حذفها
              ...
              الشخصية
              {'\n'} 0.5 الحق في نقل البيانات ، لديك الحق في الحصول على نسخة من
              بياناتك الشخصية بتنسيق منظم وقابل للقراءة آليًا وشائع الاستخدام
              ...
              ويرجى ملاحظة أننا قد لا نتمكن من تقديم الخدمة بدون بعض البيانات
              الضرورية. لديك الحق في تقديم شكوى إلى هيئة حماية البيانات بشأن
              جمعنا لبياناتك الشخصية واستخدامها ، لمزيد من المعلومات يرجى
              الاتصال بهيئة حماية البيانات المحلية في المنطقة الاقتصادية
              الأوروبية (EEA).
              {'\n'} 11. حقوق حماية البيانات الخاصة بك بموجب قانون حماية
              الخصوصية لولاية كاليفورنيا (CalOPPA) CalOPPA هو أول قانون ولاية في
              الدولة يطالب المواقع التجارية والخدمات عبر الإنترنت بنشر سياسة
              الخصوصية ، يمتد نطاق القانون إلى ما هو أبعد من ولاية كاليفورنيا
              ليطلب من شخص أو شركة في الولايات المتحدة (ويمكن تصوره للعالم)
              تشغيل مواقع الويب التي تجمع معلومات التعريف الشخصية من مستهلكي
              كاليفورنيا لنشر سياسة خصوصية واضحة على موقع الويب الخاص بها توضح
              بالضبط المعلومات التي يتم جمعها وتلك الأفراد الذين يتم مشاركتها
              معهم ، والامتثال لهذه السياسة. وفقًا لـ CalOPPA ، نوافق على ما
              يلي:
              {'\n'} 0.1. يمكن للمستخدمين زيارة موقعنا بشكل مجهول
              {'\n'} 0.2 يشتمل رابط سياسة الخصوصية الخاصة بنا على كلمة
              "الخصوصية" ، ويمكن العثور عليه بسهولة على الصفحة الرئيسية لموقعنا
              على الويب
              {'\n'} 0.3 سيتم إخطار المستخدمين بأي تغييرات في سياسة الخصوصية على
              صفحة سياسة الخصوصية الخاصة بنا
              {'\n'} 0.4 يمكن للمستخدمين تغيير معلوماتهم الشخصية عن طريق
              مراسلتنا عبر البريد الإلكتروني على info@FXC.com. سياستنا بشأن
              إشارات "عدم التعقب": نحن نحترم إشارات عدم التتبع ولا نتتبع ملفات
              تعريف الارتباط أو نزرعها أو نستخدم الإعلانات عندما تكون آلية متصفح
              عدم التعقب في مكانها الصحيح ،عدم التعقب هو تفضيل يمكنك تعيينه في
              متصفح الويب الخاص بك لإعلام مواقع الويب بأنك لا تريد أن يتم تعقبك.
              يمكنك تمكين أو تعطيل "عدم التعقب" من خلال زيارة صفحة "التفضيلات"
              أو "الإعدادات" في متصفح الويب الخاص بك.
              {'\n'} 12. حقوق حماية البيانات الخاصة بك بموجب قانون خصوصية
              المستهلك في كاليفورنيا (CCPA) إذا كنت مقيمًا في كاليفورنيا ، فيحق
              لك معرفة البيانات التي نجمعها عنك ، واطلب حذف بياناتك وعدم بيعها
              (مشاركتها). لممارسة حقوق حماية البيانات الخاصة بك ، يمكنك تقديم
              طلبات معينة و مطالبتنا بما يلي:
              {'\n'} 0.1. ما هي المعلومات الشخصية التي لدينا عنك. إذا قمت بتقديم
              هذا الطلب ، سنعود إليك:
              ...
              عنك.
              {'\n'} 0.0.6. قائمة بفئات المعلومات الشخصية التي قمنا ببيعها ، إلى
              جانب فئة أي شركة أخرى قمنا ببيعها لها. إذا لم نقم ببيع معلوماتك
              الشخصية ، فيس نبلغك بهذه الحقيقة.
              ...
              الماضية.
              {'\n'} 0.2 حذف معلوماتك الشخصية. إذا قمت بتقديم هذا الطلب ، سنقوم
              بحذف المعلومات الشخصية التي نحتفظ بها عنك اعتبارًا من تاريخ طلبك
              من سجلاتنا وتوجيه أي من مزودي الخدمة لفعل الشيء نفسه. في بعض
              الحالات ، يمكن أن يتم الحذف من خلال إلغاء تعريف المعلومات. إذا
              اخترت حذف معلوماتك الشخصية ، فقد لا تتمكن من استخدام وظائف معينة
              تتطلب تشغيل معلوماتك الشخصية.
              {'\n'} 0.3 للتوقف عن بيع معلوماتك الشخصية. نحن لا نبيع أو نؤجر
              معلوماتك الشخصية لأي طرف ثالث لأي غرض من الأغراض. نحن لا نبيع
              معلوماتك الشخصية مقابل مادي. ومع ذلك ، في بعض الظروف ، يمكن اعتبار
              نقل المعلومات الشخصية إلى طرف ثالث ، أو داخل مجموعة شركاتنا ، دون
              مقابل نقدي ، بمثابة "بيع" بموجب قانون ولاية كاليفورنيا. أنت المالك
              الوحيد لبياناتك الشخصية ويمكنك طلب الكشف أو الحذف في أي وقت. إذا
              قمت بتقديم طلب لوقف بيع معلوماتك الشخصية ، فسوف نتوقف عن إجراء
              عمليات النقل هذه. يرجى ملاحظة أنه إذا طلبت منا حذف بياناتك أو
              التوقف عن بيعها ، فقد يؤثر ذلك على تجربتك معنا ، وقد لا تتمكن من
              المشاركة في بعض البرامج أو خدمات العضوية التي تتطلب استخدام
              معلوماتك الشخصية لتعمل. ولكن في أي ظرف من الظروف ، سوف نميز ضدك
              بسبب ممارستك لحقوقك. لممارسة حقوق حماية بيانات كاليفورنيا الموضحة
              أعلاه ، يرجى إرسال طلبك (طلباتك) عبر البريد الإلكتروني:
              info@FXC.com. حقوق حماية البيانات الخاصة بك ، الموضحة أعلاه ،
              مغطاة بقانون حماية خصوصية المستهلك في كاليفورنيا ، باختصار لقانون
              خصوصية المستهلك في كاليفورنيا. لمعرفة المزيد ، قم بزيارة الموقع
              الرسمي للمعلومات التشريعية لولاية كاليفورنيا. دخلت CCPA حيز
              التنفيذ في 01/01/2020.
              {'\n'} 13. مقدمو الخدمة يجوز لنا توظيف شركات وأفراد من أطراف ثالثة
              لتسهيل خدمتنا ("مزودي الخدمة") ، أو تقديم الخدمة نيابة عنا ، أو
              أداء الخدمات المتعلقة بالخدمة أو مساعدتنا في تحليل كيفية استخدام
              خدمتنا. هذه الأطراف الثالثة لديها حق الوصول إلى بياناتك الشخصية
              فقط لأداء هذه المهام نيابة عنا وهي ملزمة بعدم الكشف عنها أو
              ...
              الخدمة. في هذه الحالة ، نستخدم خدمات الجهات الخارجية لمعالجة الدفع
              (مثل معالجات الدفع). لن نقوم بتخزين أو جمع تفاصيل بطاقة الدفع
              الخاصة بك. يتم تقديم هذه المعلومات مباشرة إلى معالجة الدفع
              التابعين لجهات خارجية والذين يخضع استخدامك لمعلوماتك الشخصية
              لسياسة الخصوصية الخاصة بهم. تلتزم معالجات الدفع هذه بالمعايير التي
              حددتها PCI-DSS كما يديرها مجلس معايير أمان PCI ، وهو جهد مشترك
              لعلامات تجارية مثل Visa و Mastercard و American Express و
              Discover. تساعد متطلبات PCI-DSS على ضمان المعالجة الآمنة لمعلومات
              الدفع.
              {'\n'} 18. روابط لمواقع أخرى قد تحتوي خدمتنا على روابط لمواقع أخرى
              لا نقوم بتشغيلها. إذا قمت بالنقر فوق ارتباط جهة خارجية ، فسيتم
              توجيهك إلى موقع هذا الطرف الثالث. ننصحك بشدة بمراجعة سياسة
              ...
              استخدامPolicyMaker.io، أداة مجانية تساعد في إنشاء مستندات قانونية
              عالية الجودة. صانع السياسة منشئ سياسة الخصوصية هي أداة سهلة
              الاستخدام لإنشاء ملف سياسة الخصوصية لمدونة أو موقع ويب أو متجر
              تجارة إلكترونية أو تطبيق جوال.
              {'\n'} 19. خصوصية الأطفال خدماتنا غير مخصصة للاستخدام من قبل
              الأطفال الذين تقل أعمارهم عن 18 عامًا ("الطفل" أو "الأطفال"). نحن
              لا نجمع عن عمد معلومات تعريف شخصية من الأطفال دون سن 18 عامًا. إذا
              علمت أن أحد الأطفال قد زودنا ببيانات شخصية ، فيرجى الاتصال بنا.
              إذا علمنا أننا جمعنا بيانات شخصية من الأطفال دون التحقق من موافقة
              الوالدين ، فإننا نتخذ خطوات لإزالة هذه المعلومات من خوادمنا.
              ...
              الإلكتروني و / أو إشعارًا بارزًا على خدمتنا ، قبل أن يصبح التغيير
              ساريًا وتحديث "التاريخ الفعلي" في الجزء العلوي من سياسة الخصوصية
              هذه. يُنصح بمراجعة سياسة الخصوصية هذه بشكل دوري لمعرفة أي تغييرات.
              تسري التغييرات التي تطرأ على سياسة الخصوصية هذه عند نشرها على هذه
              الصفحة.
              {'\n'} 21. اتصل بنا إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه ،
              يرجى الاتصال بنا عبر البريد الإلكتروني: info@FXC.com.
            </Text> */}
          </ScrollView>
          <View
            style={{
