...
const CreditInfoPopUP = props => {
  const arry = [
    { title: props.StringsList._23, value: 'total', placeholder: "0.00", editable: false },
    { title: props.StringsList._70, value: 'cashAdavance', placeholder: "0.00", editable: true },
    { title: props.StringsList._55, value: 'credit', placeholder: "0.00", editable: false },
    { title: props.StringsList._71, value: 'cashPaid', placeholder: "0.00", editable: false },
    {
      title: `${props.StringsList._16}`,
      value: 'balance', placeholder: "0.00", editable: false,
    },
    { title: props.isCredit ? props.StringsList._72 : props.StringsList._73, value: 'buyerCode', placeholder: "0.00", editable: props.isCredit ? false : true },

    { title: props.StringsList._285, value: 'name', placeholder: "name", editable: props.isCredit ? false : true },
  ];
    ...
    <Animatable.View
      ...
      <Formik
        ...
        onSubmit={values => {
          ...
          props.cashPaidAmountFun(Number(values.cashAdavance), values.buyerCode);
