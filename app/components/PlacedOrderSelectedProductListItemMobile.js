...
const PlacedOrderSelectedProductListItemMobile = ({
  item,
          ...
          <View
            ...
            <View
              ...
              <TextInput
                editable={
                  ...
                  (true && userConfiguration.PriceChangeAllowed === 1)
                }
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <View
                ...
                <TextInput
                  // editable={item?.IsParentAddOn === true || 1}
                  keyboardType="numeric"
                  onChangeText={text =>
...
export default PlacedOrderSelectedProductListItemMobile;
