...
import com.finexcloudrestarurantpos.adapter.BarcodeAdapter;
...
public class BarcodeActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent intent = new Intent(mContext, com.finexcloudrestarurantpos.activity.BarcodePrintActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString(com.finexcloudrestarurantpos.activity.BarcodePrintActivity.BUNDLE_KEY_BARCODE_TYPE, barcodeType);
